...
public class Solution
{
    ...
    {
        for(Object s :apartaments){
            if(s instanceof Apt1Room){
                ((Apt1Room) s).clean1Room();//написать тут вашу реализацию пунктов 1-4
            }
            if(s instanceof Apt2Room){
                ((Apt2Room) s).clean2Rooms();
            }
            if(s instanceof Apt3Room){
                ((Apt3Room) s).clean3Rooms();
            }
